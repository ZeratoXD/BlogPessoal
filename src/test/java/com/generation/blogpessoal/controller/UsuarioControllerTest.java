...
public class UsuarioControllerTest {
	...
	@Test
	@DisplayName("Atualizazr um Usuário")
	public void deveAtualizarUmUsuario() {

		Optional<Usuario> usuarioCadastrado = usuarioService
				.cadastrarUsuario(new Usuario(0L, "Maria da Silva", "maria_silva@email.com.br", "123456789", "-"));

		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Maria da Silva",
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(
				new Usuario(0L, "Ricardo Sanches", "ricardo_sanches@email.com.br", "ricardo123", "-"));
